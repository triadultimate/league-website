...
Welcome to the location to sign up for Summer League 2022.
...
Dates: June 9th -> Aug 20th (Saturday Tournament)  
...
Use the following address: [Hine Soccer Park: 5895 Bethabara Park, Winston-Salem, NC 27106](https://goo.gl/maps/yFRGMwxuXAsQakYx7)
...
* 10 weeks of co-ed Ultimate (from June through August) first pull at 630pm.    
* Friends!  
...
load(file= here::here("data","Summer22Clean.rda"))


teams <- 
  Summer22Clean %>% 
  select(Team, `Team Name`,Gender, Name, Role) %>% 
  arrange(Team, `Team Name`, Role, Gender, Name) %>% 
