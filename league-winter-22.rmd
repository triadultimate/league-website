...
```{r, eval=T}
teams <- readxl::read_excel(here::here("data", "2022Winter_DraftedTeams_Emails_Website.xlsx"), sheet="Sheet2") %>% 
...
We have four teams this year, with either one or two captains per team 
...
```{r echo=FALSE, out.width='50%', eval=T}
knitr::include_graphics(here::here("img","pic_2022_dark.jpg"))
```
